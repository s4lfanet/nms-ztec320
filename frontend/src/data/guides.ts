...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: 'Status Core & Riwayat (OTB, ODC, JC)',
        content: 'Saat edit OTB, ODC, atau JC yang sudah tersimpan, muncul panel **Status Core** — grid nomor core 1 sampai Total Cores, otomatis berwarna sesuai status (tersedia/dipakai) begitu ada node lain yang di-set untuk memakai core tersebut. Klik satu core untuk lihat riwayat perubahan status (siapa, kapan, dari status apa ke status apa).\n\nIni murni panel status — bukan tempat mengubah assignment. Assignment core tetap diatur lewat "Fed From" di form ODC/ODP/JC seperti biasa; panel ini cuma menampilkan apa yang tercatat dari situ.',
      },
      {
