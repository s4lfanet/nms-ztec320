import{r as e}from"./rolldown-runtime-hePW80VL.js";import{Wt as t,Zt as n,an as r,d as i,gn as a,mt as o,tn as s}from"./vendor-icons-BdDv6IDr.js";import{a as c}from"./vendor-query-CEykEIyC.js";import{a as l,r as u,s as d}from"./index-BlIvbeRl.js";import{t as f}from"./PageContainer-ZAwxUbA-.js";import{t as p}from"./PageHeader-C2RekPSP.js";import{n as m,t as h}from"./shared-xGySFe3i.js";var g=e(a(),1),_=[`Dashboard`,`ONU Management`,`Templates`,`Traffic`,`Infrastructure`,`System`,`Activity`],v=[{id:`dashboard`,category:`Dashboard`,page:`/dashboard`,title:`Panduan Dashboard`,description:`Monitor status OLT dan ONU secara real-time`,steps:[{title:`Statistik ONU`,content:`Kartu statistik menampilkan total ONU per status: **Online**, **Offline**, **DyingGasp**, **LOS** (Loss of Signal), dan **Total**.
...
`?(0,b.jsx)(`br`,{},t):e.startsWith(`**`)&&e.endsWith(`**`)?(0,b.jsx)(`strong`,{className:`text-tx1 font-semibold`,children:e.slice(2,-2)},t):(0,b.jsx)(`span`,{children:e},t))}function S({guide:e,defaultOpen:r}){let[a,c]=(0,g.useState)(r??!1);return(0,b.jsxs)(d,{bodyClassName:`p-0`,children:[(0,b.jsxs)(`button`,{onClick:()=>c(!a),className:`w-full flex items-center gap-3 p-4 text-left hover:bg-glass/50 transition-colors`,children:[(0,b.jsx)(`div`,{className:`flex-shrink-0 w-8 h-8 rounded-lg bg-accent/15 text-accent flex items-center justify-center`,children:(0,b.jsx)(t,{size:16})}),(0,b.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,b.jsx)(`h3`,{className:`text-sm font-semibold text-tx1 truncate`,children:e.title}),(0,b.jsx)(`p`,{className:`text-xs text-tx3 truncate`,children:e.description})]}),a?(0,b.jsx)(s,{size:18,className:`text-tx3 flex-shrink-0`}):(0,b.jsx)(n,{size:18,className:`text-tx3 flex-shrink-0`})]}),a&&(0,b.jsxs)(`div`,{className:`px-4 pb-4 space-y-3 animate-fade-in`,children:[e.prerequisites&&e.prerequisites.length>0&&(0,b.jsxs)(`div`,{className:`p-3 rounded-lg bg-warning/5 border border-warning/20 text-xs text-tx2`,children:[(0,b.jsxs)(`div`,{className:`flex items-center gap-1.5 mb-1.5 font-semibold text-warning`,children:[(0,b.jsx)(i,{size:14}),` Prasyarat`]}),(0,b.jsx)(`ul`,{className:`ml-4 space-y-1 list-disc`,children:e.prerequisites.map((e,t)=>(0,b.jsx)(`li`,{children:x(e)},t))})]}),(0,b.jsx)(`div`,{className:`space-y-2.5`,children:e.steps.map((e,t)=>(0,b.jsxs)(`div`,{className:`flex gap-2.5`,children:[(0,b.jsx)(`span`,{className:`flex-shrink-0 w-6 h-6 rounded-full bg-accent/15 text-accent flex items-center justify-center text-xs font-bold`,children:t+1}),(0,b.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,b.jsx)(`strong`,{className:`text-sm text-tx1`,children:e.title}),(0,b.jsx)(`p`,{className:`text-xs text-tx2 mt-0.5 leading-relaxed`,children:x(e.content)})]})]},t))}),e.tips&&e.tips.length>0&&(0,b.jsxs)(`div`,{className:`p-3 rounded-lg bg-glass border border-brd text-xs text-tx3`,children:[(0,b.jsxs)(`div`,{className:`flex items-center gap-1.5 mb-1.5 font-semibold text-tx2`,children:[(0,b.jsx)(o,{size:14,className:`text-accent`}),` Tips`]}),(0,b.jsx)(`ul`,{className:`ml-4 space-y-1 list-disc`,children:e.tips.map((e,t)=>(0,b.jsx)(`li`,{children:x(e)},t))})]})]})]})}function C(){let[e,n]=(0,g.useState)(``),[i,a]=(0,g.useState)(`All`),o=(0,g.useMemo)(()=>{let t=e?y(e):v;return i!==`All`&&(t=t.filter(e=>e.category===i)),t},[e,i]),s=(0,g.useMemo)(()=>{let e=new Map;for(let t of o)e.has(t.category)||e.set(t.category,[]),e.get(t.category).push(t);return Array.from(e.entries()).sort((e,t)=>{let n=_.indexOf(e[0]),r=_.indexOf(t[0]);return(n===-1?99:n)-(r===-1?99:r)})},[o]),c=(0,g.useMemo)(()=>{let e=new Map;for(let t of v)e.set(t.category,(e.get(t.category)||0)+1);return Array.from(e.entries()).sort((e,t)=>{let n=_.indexOf(e[0]),r=_.indexOf(t[0]);return(n===-1?99:n)-(r===-1?99:r)})},[]);return(0,b.jsxs)(f,{children:[(0,b.jsx)(p,{icon:(0,b.jsx)(r,{size:22,className:`text-accent`}),title:`Panduan`,description:`Pusat panduan penggunaan Salfanet NMS — ${v.length} panduan tersedia`}),(0,b.jsx)(m,{value:e,onChange:n,placeholder:`Cari panduan... (mis: ONU, VLAN, traffic, alert)`}),(0,b.jsxs)(h,{className:`gap-1.5`,children:[(0,b.jsxs)(`button`,{onClick:()=>a(`All`),className:`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${i===`All`?`bg-accent/15 text-accent border border-accent/20`:`bg-glass border border-brd text-tx2 hover:text-tx1 hover:border-accent/30`}`,children:[`Semua (`,v.length,`)`]}),c.map(([e,t])=>(0,b.jsxs)(`button`,{onClick:()=>a(e),className:`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${i===e?`bg-accent/15 text-accent border border-accent/20`:`bg-glass border border-brd text-tx2 hover:text-tx1 hover:border-accent/30`}`,children:[e,` (`,t,`)`]},e))]}),o.length===0?(0,b.jsx)(l,{icon:t,title:`Tidak ada panduan yang cocok dengan "${e}"`,action:(0,b.jsx)(u,{variant:`ghost`,onClick:()=>{n(``),a(`All`)},children:`Reset filter`})}):(0,b.jsx)(`div`,{className:`space-y-4`,children:s.map(([e,t])=>(0,b.jsxs)(`div`,{children:[(0,b.jsx)(`h2`,{className:`text-xs font-semibold text-tx3 uppercase tracking-wider mb-2 px-1`,children:e}),(0,b.jsx)(`div`,{className:`space-y-2`,children:t.map(e=>(0,b.jsx)(S,{guide:e,defaultOpen:o.length===1},e.id))})]},e))})]})}export{C as GuidePage};