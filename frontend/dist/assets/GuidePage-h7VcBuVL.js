import{r as e}from"./rolldown-runtime-hePW80VL.js";import{$t as t,A as n,Gt as r,Rt as i,Yt as a,d as o,dn as s,ft as c}from"./vendor-icons-D1v-titq.js";import{a as l}from"./vendor-query-D0wWsCRn.js";var u=e(s(),1),d=[`Dashboard`,`ONU Management`,`Templates`,`Traffic`,`Infrastructure`,`System`,`Activity`],f=[{id:`dashboard`,category:`Dashboard`,page:`/dashboard`,title:`Panduan Dashboard`,description:`Monitor status OLT dan ONU secara real-time`,steps:[{title:`Statistik ONU`,content:`Kartu statistik menampilkan total ONU per status: **Online**, **Offline**, **DyingGasp**, **LOS** (Loss of Signal), dan **Total**.
...
`?(0,m.jsx)(`br`,{},t):e.startsWith(`**`)&&e.endsWith(`**`)?(0,m.jsx)(`strong`,{className:`text-tx1 font-semibold`,children:e.slice(2,-2)},t):(0,m.jsx)(`span`,{children:e},t))}function g({guide:e,defaultOpen:t}){let[n,s]=(0,u.useState)(t??!1);return(0,m.jsxs)(`div`,{className:`glass-card overflow-hidden`,children:[(0,m.jsxs)(`button`,{onClick:()=>s(!n),className:`w-full flex items-center gap-3 p-4 text-left hover:bg-glass/50 transition-colors`,children:[(0,m.jsx)(`div`,{className:`flex-shrink-0 w-8 h-8 rounded-lg bg-accent/15 text-accent flex items-center justify-center`,children:(0,m.jsx)(i,{size:16})}),(0,m.jsxs)(`div`,{className:`flex-1 min-w-0`,children:[(0,m.jsx)(`h3`,{className:`text-sm font-semibold text-tx1 truncate`,children:e.title}),(0,m.jsx)(`p`,{className:`text-xs text-tx3 truncate`,children:e.description})]}),n?(0,m.jsx)(a,{size:18,className:`text-tx3 flex-shrink-0`}):(0,m.jsx)(r,{size:18,className:`text-tx3 flex-shrink-0`})]}),n&&(0,m.jsxs)(`div`,{className:`px-4 pb-4 space-y-3 animate-fade-in`,children:[e.prerequisites&&e.prerequisites.length>0&&(0,m.jsxs)(`div`,{className:`p-3 rounded-lg bg-warning/5 border border-warning/20 text-xs text-tx2`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-1.5 mb-1.5 font-semibold text-warning`,children:[(0,m.jsx)(o,{size:14}),` Prasyarat`]}),(0,m.jsx)(`ul`,{className:`ml-4 space-y-1 list-disc`,children:e.prerequisites.map((e,t)=>(0,m.jsx)(`li`,{children:h(e)},t))})]}),(0,m.jsx)(`div`,{className:`space-y-2.5`,children:e.steps.map((e,t)=>(0,m.jsxs)(`div`,{className:`flex gap-2.5`,children:[(0,m.jsx)(`span`,{className:`flex-shrink-0 w-6 h-6 rounded-full bg-accent/15 text-accent flex items-center justify-center text-xs font-bold`,children:t+1}),(0,m.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,m.jsx)(`strong`,{className:`text-sm text-tx1`,children:e.title}),(0,m.jsx)(`p`,{className:`text-xs text-tx2 mt-0.5 leading-relaxed`,children:h(e.content)})]})]},t))}),e.tips&&e.tips.length>0&&(0,m.jsxs)(`div`,{className:`p-3 rounded-lg bg-glass border border-brd text-xs text-tx3`,children:[(0,m.jsxs)(`div`,{className:`flex items-center gap-1.5 mb-1.5 font-semibold text-tx2`,children:[(0,m.jsx)(c,{size:14,className:`text-accent`}),` Tips`]}),(0,m.jsx)(`ul`,{className:`ml-4 space-y-1 list-disc`,children:e.tips.map((e,t)=>(0,m.jsx)(`li`,{children:h(e)},t))})]})]})]})}function _(){let[e,r]=(0,u.useState)(``),[a,o]=(0,u.useState)(`All`),s=(0,u.useMemo)(()=>{let t=e?p(e):f;return a!==`All`&&(t=t.filter(e=>e.category===a)),t},[e,a]),c=(0,u.useMemo)(()=>{let e=new Map;for(let t of s)e.has(t.category)||e.set(t.category,[]),e.get(t.category).push(t);return Array.from(e.entries()).sort((e,t)=>{let n=d.indexOf(e[0]),r=d.indexOf(t[0]);return(n===-1?99:n)-(r===-1?99:r)})},[s]),l=(0,u.useMemo)(()=>{let e=new Map;for(let t of f)e.set(t.category,(e.get(t.category)||0)+1);return Array.from(e.entries()).sort((e,t)=>{let n=d.indexOf(e[0]),r=d.indexOf(t[0]);return(n===-1?99:n)-(r===-1?99:r)})},[]),h=(0,u.useCallback)(()=>r(``),[]);return(0,m.jsxs)(`div`,{className:`space-y-4`,children:[(0,m.jsxs)(`div`,{children:[(0,m.jsxs)(`h1`,{className:`text-xl md:text-2xl font-bold flex items-center gap-2`,children:[(0,m.jsx)(t,{size:22,className:`text-accent`}),` Panduan`]}),(0,m.jsxs)(`p`,{className:`text-tx2 text-xs md:text-sm mt-1`,children:[`Pusat panduan penggunaan Salfanet NMS — `,f.length,` panduan tersedia`]})]}),(0,m.jsx)(`div`,{className:`flex flex-col md:flex-row gap-3`,children:(0,m.jsxs)(`div`,{className:`relative flex-1`,children:[(0,m.jsx)(n,{size:16,className:`absolute left-3 top-1/2 -translate-y-1/2 text-tx3`}),(0,m.jsx)(`input`,{type:`text`,value:e,onChange:e=>r(e.target.value),placeholder:`Cari panduan... (mis: ONU, VLAN, traffic, alert)`,className:`w-full pl-9 pr-9 py-2.5 rounded-xl bg-glass border border-brd text-sm text-tx1 placeholder:text-tx3 focus:outline-none focus:border-accent/30 transition-colors`}),e&&(0,m.jsx)(`button`,{onClick:h,className:`absolute right-3 top-1/2 -translate-y-1/2 text-tx3 hover:text-tx1 text-sm`,children:`✕`})]})}),(0,m.jsxs)(`div`,{className:`flex flex-wrap gap-1.5`,children:[(0,m.jsxs)(`button`,{onClick:()=>o(`All`),className:`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${a===`All`?`bg-accent/15 text-accent border border-accent/20`:`bg-glass border border-brd text-tx2 hover:text-tx1 hover:border-accent/30`}`,children:[`Semua (`,f.length,`)`]}),l.map(([e,t])=>(0,m.jsxs)(`button`,{onClick:()=>o(e),className:`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${a===e?`bg-accent/15 text-accent border border-accent/20`:`bg-glass border border-brd text-tx2 hover:text-tx1 hover:border-accent/30`}`,children:[e,` (`,t,`)`]},e))]}),s.length===0?(0,m.jsxs)(`div`,{className:`glass-card p-8 text-center`,children:[(0,m.jsx)(i,{size:32,className:`text-tx3 mx-auto mb-2`}),(0,m.jsxs)(`p`,{className:`text-tx2 text-sm`,children:[`Tidak ada panduan yang cocok dengan "`,e,`"`]}),(0,m.jsx)(`button`,{onClick:()=>{r(``),o(`All`)},className:`mt-3 text-xs text-accent hover:underline`,children:`Reset filter`})]}):(0,m.jsx)(`div`,{className:`space-y-4`,children:c.map(([e,t])=>(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`h2`,{className:`text-xs font-semibold text-tx3 uppercase tracking-wider mb-2 px-1`,children:e}),(0,m.jsx)(`div`,{className:`space-y-2`,children:t.map(e=>(0,m.jsx)(g,{guide:e,defaultOpen:s.length===1},e.id))})]},e))})]})}export{_ as GuidePage};